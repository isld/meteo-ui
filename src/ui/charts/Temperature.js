...
const xField = 'dateTime';
const yField = 'outTemp';
...
export default class Temperature extends React.PureComponent {
  ...
  static getDerivedStateFromProps(nextProps, prevState) {
    ...
    lineGenerator.x(d => xScale.domain(domain.x)(d[xField]));
  ...
  updateDimensions = () => {
    ...
    const xScale = d3.scaleLinear().range([margin.left, width - margin.left - margin.right]);
